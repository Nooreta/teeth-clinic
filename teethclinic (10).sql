...
CREATE TABLE `attendance` (
  ...
  `attendance_yes_no` varchar(3) CHARACTER SET utf8 NOT NULL DEFAULT 'No',
...
INSERT INTO `attendance` (`ID`, `ID_secretary`, `attendance_yes_no`, `time`, `date`) VALUES
(1, 1, 'Yes', '01:37:40 ?', '2019-05-10'),
(2, 2, 'Yes', '01:38:55 ?', '2019-05-10');
...
(3, 'noor', 'Male', '1999-05-13', 0, 'noor99@gmail.com', '     ', '7-2 am', '       ', '456', '      ');
...
ALTER TABLE `attendance`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `ID _secretary's` (`ID_secretary`);
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `attendance_ibfk_1` FOREIGN KEY (`ID_secretary`) REFERENCES `secretaries` (`ID`);
